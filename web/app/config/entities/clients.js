...
export default {
  ...
  form: {
    fields: [
      ...
      { key: 'taxId', type: 'text', label: 'fields.taxId', maxLength: 64 },
      { key: 'registrationNumber', type: 'text', label: 'fields.registrationNumber', maxLength: 64 },
      { key: 'code', type: 'text', label: 'fields.code', maxLength: 32 },
