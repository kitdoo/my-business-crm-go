...
// Inventory.Quantity switched from whole units to hundredths of a unit (the
// same basis-points convention as ProductPrice.PriceAmount — see
// entities.Inventory.Quantity) so fractional stock (e.g. 2.16 m²) can be
