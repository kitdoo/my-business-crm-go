...
type Service interface {
	...
	// negative) for (productID, warehouseID), creating the row on first
	...
	ApplyMovement(ctx context.Context, productID, warehouseID string, delta int64) (*entities.Inventory, error)
