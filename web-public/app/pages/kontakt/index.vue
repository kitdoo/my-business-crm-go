      ...
      <div class="lg:col-span-2">
        <ul class="flex flex-col gap-4 text-black/80">
          <li class="flex items-start gap-3">
            ...
            <span>
              <span class="block text-lg font-bold uppercase tracking-wide text-black">{{ t('contact.showroomLabel') }}</span>
              <span>{{ t('contact.address') }}</span>
            </span>
          </li>
          <li class="flex items-center gap-3">
            <UIcon name="i-lucide-phone" class="w-5 h-5 text-brand-600 flex-shrink-0" />
            <a href="tel:+381655632551">+381 65 563 2551</a>
          </li>
          <li class="flex items-center gap-3">
            <UIcon name="i-lucide-mail" class="w-5 h-5 text-brand-600 flex-shrink-0" />
